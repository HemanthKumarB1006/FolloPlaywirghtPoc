...
test.describe('Login Page Test Scenarios', () => {
    ...
    test('Verify user can Creat a Delivery Booking', async ({ page }) => {
        // await page.click(locators.SettingDropdown);
        await page.mouse.wheel(0, 1500);
        await page.click(locators.clickALLBookings);
        await page.click(locators.clickCraneBookings);
        await page.click(locators.clickCreateNewCraneBookings); 
        const baseText = testData.Crane.Crane.CraneInput.craneDescription;
        ...
        await page.fill(locators.enterFromTimeHH,testData.Crane.CraneInput.fromTimeHH);
